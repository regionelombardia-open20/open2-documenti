...
/**
 * Class WidgetIconDocumentiAclSharedWithMe
 * @package open20\amos\documenti\widgets\icons
 */
class WidgetIconDocumentiAclSharedWithMe extends WidgetIcon
{
    /**
     * @inheritdoc
     */
    public function init()
    {
        ...
        $this->setLabel(AmosDocumenti::tHtml('amosdocumenti', '#documenti_widget_label_acl_shared_with_me'));
