...
/**
 * Class WidgetIconDocumentiAclDashboard
 * @package open20\amos\documenti\widgets\icons
 */
class WidgetIconDocumentiAclDashboard extends WidgetIcon
{
    /**
     * @inheritdoc
     */
    public function init()
    {
        ...
        $this->setLabel(AmosDocumenti::t('amosdocumenti', '#documenti_widget_label_acl_dashboard'));
        $this->setDescription(AmosDocumenti::t('amosdocumenti', '#documenti_widget_description_acl_dashboard'));
