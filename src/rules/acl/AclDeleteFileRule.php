...
/**
 * Class AclDeleteFileRule
 * @package open20\amos\documenti\rules\acl
 */
class AclDeleteFileRule extends BasicContentRule
{
    /**
     * @inheritdoc
     */
    public $name = 'aclDeleteFile';
    ...
    public function ruleLogic($user, $item, $params, $model)
    {
        ...
        if ($userPermissionCode == AclDocumentsUtility::MANAGE_ALL_CONTENT) {
            return true;
        }
