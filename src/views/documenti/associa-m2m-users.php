...
$this->title = AmosDocumenti::t('amosdocumenti', '#associa_m2m_share_with_users_page_title', ['folderName' => $model->titolo]);
...
$modelData = $model->getFolderUserProfiles();
...
<?= M2MWidget::widget([
    ...
    'modelTargetSearch' => [
        'class' => $adminModule->model('UserProfile'),
        'query' => $appController->getAssociaM2mUsersQuery($model),
    ],
    'gridId' => 'folder-users-grid',
    'viewSearch' => true,
